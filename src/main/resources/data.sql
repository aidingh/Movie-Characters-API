...
-- Function can be run as the application starts. This can be configured in the application properties.

-- INSERT: insert characters into postgres DB
...
-- INSERT: insert franchise into postgres DB
...
-- INSERT: insert movie and link it with franchise_id.
...
-- INSERT: defined linking ids of movies and characters in the linking table.
